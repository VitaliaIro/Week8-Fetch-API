...
window.onload = () => {
    let url = 'https://api.themoviedb.org/3/movie/157336?api_key=19f515e196d73cff0802ae5f5a6f4363'
    ...
    .then(data => {
        ...
        releaseDate.textContent = `${date.getFullYear()} ${data.production_countries[0].iso_3166_1}, ${data.production_countries[1].iso_3166_1}`;
